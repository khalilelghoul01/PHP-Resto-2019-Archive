...
if (!isset($_GET['type'])) {
  ...
  <div class='dropdown-menu'>
    <a style='width:80%;' href='email.php?type=reserv'>email de reservation</a><br><br>
    <a style='width:80%;' href='email.php?type=abo'>email de d'abonnés</a>
  </div>
  </div></center></form>";
} else {
